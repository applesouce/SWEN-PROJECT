...
1. Clone the repository and go to the root/estore-api directory.
2. Execute `mvn compile exec:java`
3. Then, using another terminal, go to the root/estore-ui/music-estore subdirectory
4. Execute ng add @angular/material if it is on a new machine
5. Execute ng serve
